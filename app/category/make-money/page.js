// app/category/make-money/page.js
...
export async function generateMetadata({ searchParams }) {
  ...
  return {
    title: `Make Money Online in Nigeria - Trendzlib (Page ${currentPage > 1 ? currentPage : ''})`,
    description: `Learn how to make money online in Nigeria through freelancing, remote jobs, digital products and proven strategies. Page ${currentPage}.`,
