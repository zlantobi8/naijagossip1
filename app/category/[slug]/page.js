// app/page.js - FIXED VERSION (Correct category names)
...
export default async function Home() {
  ...
  console.log('Entertainment posts:', allEntertainment.length); // Debug
  console.log('Sports posts:', allSports.length); // Debug
            ...
            <div className="row">
              <div className="col-xl-6 col-lg-5 align-self-center">
                <div className="logo text-md-left text-center">
                  <Image src="/assets/img/naija.png" alt="Trendzlib" width={200} height={60} priority />
                </div>
              </div>
