  ...
  return (
    <div className="bg-light text-dark">
      ...
      <div className="container py-5" style={{ fontSize: "0.95rem", lineHeight: "1.8" }}>
        ...
        <p>
          At <strong> Trendzlib</strong>, your privacy is very important to us. This privacy policy outlines the types of information we collect,
        ...
        <ul>
          <li>Email: <a href="mailto:newsroom@Trendzlib.com">newsroom@Trendzlib.com</a></li>
