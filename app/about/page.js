...
export const metadata = {
  title: "About Us | Naija Gossip",
  description: "Learn more about Naija Gossip, our mission, journalism, and values.",
};
  ...
  return (
    <div className="bg-light text-dark">
      ...
      <div className="container py-5" style={{ fontSize: "0.95rem", lineHeight: "1.8" }}>
        ...
        <p><strong>Naija Gossip</strong> is a fully digital media platform powered by Naija Gossip Media.</p>
        ...
        <p>At Naija Gossip, we prioritize truth, accuracy, and clarity in our journalism. We believe that credible reporting builds trust—and trust is the foundation of our relationship with you.</p>
        ...
        <p><strong>Email:</strong> <a href="mailto:newsroom@naijagossip.com">newsroom@naijagossip.com</a></p>
        ...
        <p><strong>Connect With Us:</strong><br />
          ...
          Facebook: <a href="https://www.facebook.com/officialnaijagossip" target="_blank">facebook.com/officialnaijagossip</a><br />
